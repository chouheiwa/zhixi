    ...
    <Card title="赚钱效率趋势" size="small">
      ...
      <FormulaBlock
        ...
        items={[
          {
            name: '每千次阅读收益',
            formula: 'RPM = (当日收益 ÷ 当日阅读量) × 1000',
            desc: '衡量每1000次阅读能带来多少收益，数值越高说明内容变现效率越好。',
          },
          {
            name: '7日趋势线（指数移动平均 EMA）',
            formula: 'EMA(t) = α × 当日值 + (1-α) × 昨日EMA\nα = 2 ÷ (7+1) = 0.25',
            desc: '对最近7天的数据做加权平均，越近的数据权重越大。比简单平均更能反映最新趋势。',
          },
        ]}
      />
